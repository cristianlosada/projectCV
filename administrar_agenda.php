...
$agenda = new Agenda();
	...
	// si el elemento insertar no viene nulo llama al crud e inserta un cv
	...
	// si el elemento de la vista con nombre actualizar no viene nulo, llama al crud y actualiza el cv
